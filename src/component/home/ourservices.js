  ...
  return (
    <>
      <div data-aos="fade-up"
        data-aos-duration="2000" data-aos-anchor-placement="top-bottom" className="lg:w-[100%] grid justify-items-center text-center mt-10 ">

        <h4 className="tracking-[1px] font-[700] leading-[43px] lg:leading-[60px] text-[48px] lg:text-[65px] mt-[40px] lg:mt-[122px] text-[#006cfc]">
       Our Services
        </h4>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 pt-[10px] justify-items-center">
          <div ref={buttonRef} className="pt-[46px]">
            <div class="image-swap">
              ...
              <img src="/Homepage/Enterprise Whitebg.svg" alt="Image 2" class="opacity-0" />
            </div>
