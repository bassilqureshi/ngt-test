...
import video1080 from "../../video-1080.mp4";
...
const HeroSection = ({ videoRef }) => {
  ...
  const handlePlayVideo = () => {
    ...
    // Change navbar_main z-index to 0
  ...
  const handleCloseVideo = () => {
    ...
    // Change navbar_main z-index back to 40
    const navbar = document.querySelector('.navbar_main');
    if (navbar) {
  ...
  return (
    <>
      <div className="relative h-screen flex items-center justify-center bg-gray-800 overflow-hidden">
        ...
        {!showVideo && (
          <>
            <div className="banner_caption relative z-10">
            ...
            <div className="relative w-full h-full flex justify-end items-end">
              ...
              <div className="absolute flex justify-center items-center p-5">
                <div className="flex-col lg:pr-1 xl:pr-3">
                  ...
                  <NavLink
                    to="/contact-us#contact-form-section"
                    // to={{
                    //   pathname: "/contact-us",
                    //   state: { targetSection: "contact-form-section" } // Pass the target section as state
                    // }}
                  >
                    <Button
                      variant="contained"
