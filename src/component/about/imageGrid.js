...
const ImageGrid = () => {
  ...
  return (
    <>
      <div className='queremos-page about_image_grid who_we_sec'>
        <div className='page-content'>
          <div className="place-images">
            <Box
              ...
              className="zoom-in place_images_logo absolute inset-0 top-[30vh] md:top-[55vh] lg:top-[10vh] 2xl:top-[5vh] flex justify-center items-center"
            >
              <img
                src="/About/AboutImgLogo.svg"
                className=" w-[150px] md:w-[300px] lg:w-[480px] z-10 attract"
                style={{
