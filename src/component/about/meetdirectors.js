      ...
      <div id="our-board">
        <div className="relative pt-0">
          ...
          <div className="lottie_animation_main_heading absolute inset-0 flex flex-col justify-center items-start pl-5 lg:pl-32">
            ...
            <h3 className="lg:text-[20px] text-[17px]  leading-[20px] lg:leading-[26px]  font-[300] w-[95%] md:w-[50%] lg:w-[40%] 2xl:w-[30%]  md:ml-[20px] lg:ml-[40px] xl:ml-[40px] 2xl:ml-[70px] pt-20 mt-5 lg:pt-20 text-[#9fa6b6]">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 justify-items-center lg:px-10 xl:px-20  2xl:px-40 mt-5 ">
          <div class="team_item fade-up relative  w-[120px] sm:w-[285px] md:w-[297px] lg:w-[277px] lg:h-[350px]  2xl:w-[297px] 2xl:h-[375px] h-auto">
            <img src="/About/MeetDirectors1.png" alt="Image 1" class=" w-[120px] sm:w-[285px] md:w-[297px] lg:w-[100%] h-auto  transition-opacity duration-500 ease-in-out hover:opacity-0" />
            <div class="team_item_content absolute top-0 left-0  h-full w-full flex p-8 padd_board bg-blue-500 opacity-0 transition-opacity duration-500 ease-in-out hover:opacity-100 ">
              <p class="text-white text-[12px] md:text-[15px] leading-[27px] ">Johnathan Reynolds brings over 25 years of leadership experience in the technology sector. As Chairman, he oversees strategic decision-making, guiding the company toward sustainable growth and innovation</p>
              <div class="team_item_footer absolute bottom-0 right-0 pl-[31px] pt-[13px] h-[65px] w-[234px] opacity-80  bg-[#FFFFFF]">
                <h2 className="text-[15px] font-[700]">Johnathan Reynolds</h2>
          ...
          <div class="team_item fade-up relative  w-[120px] sm:w-[285px] md:w-[297px] lg:w-[277px] lg:h-[350px]   2xl:w-[297px] 2xl:h-[375px] h-auto">
            <img src="/About/MeetDirectors2.png" alt="Image 1" class=" w-[120px] sm:w-[285px] md:w-[297px] lg:w-[100%] h-auto  transition-opacity duration-500 ease-in-out hover:opacity-0" />
            <div class="team_item_content absolute top-0 left-0 h-full w-full flex p-8 padd_board bg-blue-500 opacity-0 transition-opacity duration-500 ease-in-out hover:opacity-100 ">
          ...
          <div class="team_item fade-up relative  w-[120px] sm:w-[285px] md:w-[297px] lg:w-[277px] lg:h-[350px]   2xl:w-[297px] 2xl:h-[375px] h-auto">
            <img src="/About/MeetDirectors3.png" alt="Image 1" class=" w-[120px] sm:w-[285px] md:w-[297px] lg:w-[100%] h-auto  transition-opacity duration-500 ease-in-out hover:opacity-0" />
            <div class="team_item_content absolute top-0 left-0 h-full w-full flex p-8 padd_board bg-blue-500 opacity-0 transition-opacity duration-500 ease-in-out hover:opacity-100 ">
          ...
          <div class="team_item fade-up relative  w-[120px] sm:w-[285px] md:w-[297px] lg:w-[277px] lg:h-[350px]   2xl:w-[297px] 2xl:h-[375px] h-auto">
            <img src="/About/MeetDirectors4.png" alt="Image 1" class=" w-[120px] sm:w-[285px] md:w-[297px] lg:w-[100%] h-auto  transition-opacity duration-500 ease-in-out hover:opacity-0" />
