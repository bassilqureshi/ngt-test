...
const HeroSection = () => {
  ...
  return (
    <>
      <div className={`training_hero_sec main_training_banner relative h-[100vh] lg:h-[100vh] flex items-center z-30 justify-center bg-[#7245CE] overflow-hidden`}>
        <img
          className="absolute inset-0 w-full h-full object-fill"
          src="/Training/bg-img.jpg"
          alt="Contacthero"
        />
        ...
        <div className="training_hero_text relative w-full xl:mt-[-30px] 2xl:mt-[-100px] contact_page_main">
          <div className="relative z-20 flex flex-col gap-y-10 text-left items-center justify-center">
            ...
            {/* text-[#4f289d] */}
            <h2
              className={`contact_subtitle text-[#444444] mt-[-35px] text-center font-[300] lg:flex text-[20px] transition-opacity duration-1000 ${showText ? 'opacity-100' : 'opacity-0'}`}
            >
              Meet Excellence with Our Comprehensive Training
            </h2>
          </div>
        </div>
      </div>
